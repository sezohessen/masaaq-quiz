        ...
        <div class="bg-white shadow rounded-lg mb-5 xl:mb-8">
            <div class="py-4 px-6">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <a href="{{ route('admin.tenants.create') }}" class="px-4 py-2 bg-green-600 text-white rounded-md flex items-center" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="{{ __('Add') }}">
                        <span class="mr-2">
